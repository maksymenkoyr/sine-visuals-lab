 ...
 *   for overload.
 * - "on": a deliberate, user-forced saver — quality stays at the tier
 *   baseline (nothing is cut), but the render-rate cap drops to
 ...
 *   whatever detectTier() found, for a session where dropped frames are
 *   preferable to any quality loss.
 *
