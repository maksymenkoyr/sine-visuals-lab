...
const SETTINGS: SceneSetting[] = [
  ...
  },
  {
    ...
    // Look, not Post — it's a draw-mode switch composited alongside the
    // surface tint and grid lines (see MESH_FRAG), the same kind of call as
    // dancers' Renderer, not a filter over an already-finished frame.
    group: "Look",
    min: 0,
    max: 1,
    step: 1,
