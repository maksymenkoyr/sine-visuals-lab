...
// Kept under its own id after src/render/scenes/moire.ts was rebuilt
// (2026-09-11) from a measured reference — see that file's header. This is
// the original draft: three line gratings at slowly drifting angles,
// interfering. Each grating's spatial frequency and rotation is driven by a
// band group (low/mid/high), so beat frequencies emerge and sweep across the
// frame as the music changes. Op-art, hard-edged, and the cheapest of the
// five to draw.
const FRAG = `
...
export const moire2Scene = createFullscreenScene("moire2", "Moiré 2", FRAG);
