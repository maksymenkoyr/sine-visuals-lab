...
Ours heard through `spectrum`: 3572 probe samples, 163 onsets vs the reference's 176.
...
- 7 single transitions: 0 on a beat with an onset, 3 off-beat with no onset (timer/scripted) — ours: onset fired at 5/7 of them
...
- ours: tempo at ×1 for 74% of the clip, ×½ 0%, ×2 0%, elsewhere 26% (median 120.1 vs reference 117.5); our onset lands within 60 ms of 71% of the reference's onsets, and 75% of ours sit on one of theirs; lag +4 ms ±24
...
|---|---|---|---|---|---|---|---|
| 16 | 3 | -0.18 | +0.08 | +0.27 | +0.07 | -0.37 | 3/3 |
| 8 | 3 | -0.10 | +0.89 | -0.39 | +1.07 | +0.55 | 3/3 |
| 4 | 7 | +0.01 | +0.35 | +0.12 | +1.03 | +0.44 | 6/7 |
| 2 | 14 | +0.07 | +0.58 | +0.36 | +0.67 | -0.07 | 13/13 |
| 1 | 26 | +0.05 | +0.37 | +0.23 | +0.61 | +0.40 | 24/26 |
...
|---|---|---|---|---|---|---|---|---|
| 20.07 | #39 | +51 | 1 | +0.4 | -0.9 | -1.2 | -0.8 | on beat (r1), no onset, mid drops, ours: onset no, bpm 119 |
| 22.27 | #43 | +231 | 1 | +1.9 | +1.1 | +2.1 | +1.0 | off-beat (+0.45 beat from r1), hard onset, low jumps, mid jumps, high jumps, section boundary, ours: onset yes, bpm 120 |
| 24.33 | #48 | -187 | 2 | +0.9 | +1.2 | +0.3 | +1.0 | off-beat (-0.37 beat from r2), onset, low jumps, ours: onset yes, bpm 120 |
| 24.67 | #48 | +146 | 2 | -0.1 | -0.7 | +0.9 | +2.0 | off-beat (+0.29 beat from r2), no onset, high jumps, looks like a cut, → probably not audio-driven, ours: onset yes, bpm 120 |
| 26.00 | #51 | -30 | 1 | -0.1 | +0.2 | -3.1 | -0.8 | STROBE to 26.53s: 3 flashes every 0.27s = 0.52 beat (≈ 0.5 beat within the ±0.13-beat resolution of 15 fps), starts on beat r1, no onset, mid drops, ours: onset yes, bpm 120 |
| 27.27 | #52 | +749 | 2 | +0.6 | +0.7 | +1.3 | +0.2 | off-beat (+1.47 beat from r2), no onset, mid jumps, → probably not audio-driven, ours: onset yes, bpm 120 |
| 28.47 | #52 | +1949 | 2 | +1.3 | +0.4 | -0.8 | -0.9 | off-beat (+3.82 beat from r2), onset, ours: onset yes, bpm 120 |
| 28.93 | #52 | +2416 | 2 | -0.5 | +1.2 | +0.9 | +0.6 | off-beat (+4.73 beat from r2), no onset, low jumps, → probably not audio-driven, ours: onset no, bpm 120 |
...
|---|---|---|---|---|---|---|---|---|---|
| #2 | 1.51 | 4 | +2.8 | -0.2 | -0.1 | +0.1 | +0.0 | yes | 165 |
| #6 | 3.53 | 16 | +2.6 | -0.2 | -0.0 | -0.6 | -0.6 | yes | 160 |
| #10 | 5.53 | 4 | +3.7 | -0.6 | -0.3 | -1.2 | -0.8 | yes | 161 |
| #14 | 7.52 | 8 | +4.2 | +0.4 | +0.0 | -1.9 | +0.2 | yes | 161 |
| #18 | 9.52 | 4 | +0.8 | -0.2 | -0.0 | -1.3 | -0.6 | no | 119 |
| #20 S | 10.52 | 2 | +1.0 | -0.5 | -0.4 | -1.0 | -0.7 | yes | 119 |
| #22 | 11.52 | 16 | +1.2 | -1.0 | -0.1 | -0.7 | +0.5 | yes | 120 |
| #26 | 13.51 | 4 | +1.8 | +0.2 | -0.0 | -0.0 | -0.3 | yes | 120 |
| #28 S | 14.51 | 2 | +2.1 | -0.8 | -0.6 | +0.3 | -0.1 | yes | 120 |
| #30 | 15.51 | 8 | +2.1 | -0.1 | -0.3 | +0.5 | -0.1 | yes | 120 |
| #34 | 17.53 | 4 | +2.8 | +0.2 | +0.1 | +0.8 | -0.2 | yes | 120 |
| #38 | 19.53 | 16 | +2.9 | -0.0 | -0.0 | +0.9 | +0.3 | yes | 120 |
| #42 | 21.52 | 4 | +2.8 | -0.7 | +0.1 | +0.6 | +2.3 | yes | 120 |
| #43 S | 22.04 | 1 | +0.0 | +0.1 | -0.3 | +1.2 | +2.7 | yes | 120 |
| #46 | 23.52 | 8 | +2.8 | +0.2 | +0.5 | +1.1 | +2.5 | yes | 120 |
| #50 | 25.52 | 4 | +0.7 | -0.4 | +0.1 | +1.3 | +2.0 | yes | 120 |

## Files

- `keyframes.png` — 16 tiles: regimes, transition before/after, phrase starts. Open this first.
