...
by contributors to the Maintainer. It is adapted from the Apache Software
Foundation's Individual Contributor License Agreement. This is a legally
...
copyright owner that is entering into this Agreement with the Maintainer. For
...
submitted by You to the Maintainer for inclusion in, or documentation of, the
Project. For the purposes of this definition, "submitted" means any form of
electronic, verbal, or written communication sent to the Maintainer or the
Project's repositories, including but not limited to pull requests, patches,
and issue-tracker submissions, but excluding communication that is
...
(a) You are legally entitled to grant the above licenses. If Your employer
...
agreement with the Maintainer covering Your Contributions.

(b) Each of Your Contributions is Your original creation. Where any part of a
Contribution is not Your original creation, You will identify it as such,
together with complete details of its source and of any license or other
restriction (including, but not limited to, related patents, trademarks, and
license agreements) of which You are personally aware.
...
record, constitutes your electronic signature to this Agreement, recorded
